...
| 3 | Running | ACT training on RTX 6000D (52M params, 10K steps) |
| 4 | Partial | SmolVLA exploration (450M, model loaded) |
...
|--------|--------|-------------------|--------|
| **ACT** | 52M | 30+ | Training (Phase 3) |
| Diffusion Policy | ~30M | — | Validated (Phase 1) |
| SmolVLA | 450M | 4-5 | Loaded (Phase 4) |
...
│   ├── so101_references/            # HF model survey + third-party demos
│   └── training_logs/               # Session-by-session logs
├── STL/ STEP/ Optional/             # Hardware models (from upstream)
└── README.md
```
